...
int main(int argc, char* argv[]) {
	...
	algorithm.RXsPath = {
		...
		{Point(3560000,2280000),Point(3560000,164080),Point(9470000,164080),Point(9470000,2600000),Point(8840000,2600000)},
		{Point(3560000,2280000),Point(3560000,164080),Point(9470000,164080),Point(9470000,2862000),Point(8944000,2862000),Point(8944000,3226998)},
		{Point(3560000,2280000),
		Point(3560000,164080),
		Point(9470000,164080),
		Point(9470000,2679998),
		Point(7880000,2679998)},

		{Point(3560000,2280000),
		Point(3560000,164080),
		Point(9470000,164080),
		Point(9470000,2862000),
		Point(8068972,2862000),
		Point(8068972,2920000),
		Point(8040000,2920000)},

		{Point(3560000,2280000),
		Point(3560000,164080),
		Point(9470000,164080),
		Point(9470000,2862000),
		Point(8840000,2862000),
		Point(8840000,3880000),
		Point(8760000,3880000)},

		{Point(3560000,2280000),
		Point(3560000,164080),
		Point(9569000,164080),
		Point(9569000,2865800),
		Point(9678984,2865800),
		Point(9678984,5254000),
		Point(9639000,5254000),
		Point(9639000,5320000)},

		{Point(3560000,2280000),
		Point(3560000,164080),
		Point(9470000,164080),
		Point(9470000,2862000),
		Point(7760000,2862000),
		Point(7760000,3800000),
		Point(7640000,3800000)},

		{Point(3560000,2280000),
		Point(3560000,164080),
		Point(9470000,164080),
		Point(9470000,2862000),
		Point(7965000,2862000),
		Point(7965000,5480000),
		Point(7880000,5480000)},
		...
		Point(9470000,2862000),
		Point(7760000,2862000),
		Point(7760000,4040000),
		Point(6840000,4040000)},
		...
		Point(9470000,2862000),
		Point(7760000,2862000),
		Point(7760000,2950000),
		Point(6808000,2950000),
		Point(6808000,2912000),
		Point(6760000,2912000)},

		{Point(3560000,2280000),
		Point(3560000,2886420),
		Point(675000,2886420),
		Point(675000,3283000),
		Point(107000,3283000),
		Point(107000,5313000),
		Point(34000,5313000),
		Point(34000,6090000),
		Point(705000,6090000),
		Point(705000,6198998),
		Point(760000,6198998)},

		{Point(3560000,2280000),
		Point(3560000,164080),
		Point(9470000,164080),
		Point(9470000,2862000),
		Point(8680000,2862000),
		Point(8680000,6171999),
		Point(8440000,6171999),
		Point(8440000,6198998)},
		...
		Point(9470000,2862000),
		Point(7760000,2862000),
		Point(7760000,4600000),
		Point(6680000,4600000)},
		...
		Point(7760000,2950000),
		Point(6808000,2950000),
		Point(6808000,2280000),
		Point(6760000,2280000)},
		...
		Point(9470000,2862000),
		Point(7760000,2862000),
		Point(7760000,4520000),
		Point(6120000,4520000)},
		...
		Point(9470000,2862000),
		Point(7760000,2862000),
		Point(7760000,3079998),
		Point(4680000,3079998)},
		...
		Point(34000,5313000),
		Point(34000,6090000),
		Point(1418000,6090000),
		Point(1418000,6198998),
		Point(2040000,6198998)},
		...
		Point(34000,5313000),
		Point(34000,6090000),
		Point(2890000,6090000),
		Point(2890000,6119998),
		Point(2920000,6119998)},
		...
		Point(34000,5313000),
		Point(34000,6090000),
		Point(4770000,6090000),
		Point(4770000,6120000),
		Point(4840000,6120000)},
		...
		Point(9470000,2862000),
		Point(7760000,2862000),
		Point(7760000,4799120),
		Point(5041480,4799120),
		Point(5041480,5640000),
		Point(5000000,5640000)}
	};
